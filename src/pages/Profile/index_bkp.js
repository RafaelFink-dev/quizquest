...
export default function Profile() {
    ...
    async function handleSubmit(e) {
        ...
        if (!user.instituicao) {
            const instituicaoAtualizada = instituicao[instituicaoSelected]?.nomeInstituicao;
            const cursoAtualizado = cursos[courseSelected]?.nomeCurso;
            const turmaAtualizada = turmas[turmaSelected]?.nomeTurma;
